...
class V8_EXPORT V8 {
  ...
  */
  ...
  /**
   * Create a new isolate and context for the puprose of captureing a code snapshot
   * Returns { NULL, 0 } on failure.
   * The caller owns the data array in the return value.
   */
#if VMOLAB_CODESNAPSHOT
  static StartupData CreateCodeSnapshotDataBlob(const char* script_name = NULL,
