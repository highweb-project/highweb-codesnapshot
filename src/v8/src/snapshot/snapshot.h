...
class Snapshot : public AllStatic {
 public:
  ...
  static v8::StartupData CreateCodeSnapshotBlob(
      const List<byte>& payload, const CodeSerializer& cs,
      bool embeds_script);
#endif
...
#if VMOLAB_CODESNAPSHOT
  // Code Snapshot blob layout:
  // [0] metadata
  // [1] serialized code data length
  // [2] serialized code data (SerializedCodeData)
  static const int kCodeLengthOffset = kMetadataOffset + kInt32Size;
  static const int kCodeDataOffset = kCodeLengthOffset + kInt32Size;
#endif
